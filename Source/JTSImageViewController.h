...
typedef NS_OPTIONS(NSInteger, JTSImageViewControllerDismissalOptions) {
    JTSImageViewControllerDismissalOption_Flick     = 1 << 0,
    JTSImageViewControllerDismissalOption_SingleTap = 1 << 1,
    JTSImageViewControllerDismissalOption_Pinch     = 1 << 2
};
...
@property (assign, nonatomic) JTSImageViewControllerDismissalOptions dismissalOptions;
